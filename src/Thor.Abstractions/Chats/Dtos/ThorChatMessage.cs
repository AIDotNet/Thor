...
public class ThorChatMessage
{
    ...
    public ThorChatMessage(string role, string content, string? name = null, IList<ToolCall>? toolCalls = null,
    ...
    /// <param name="toolCallId">The tool function call id generated by the model</param>
    /// <param name="toolCalls">The tool calls generated by the model.</param>
    public ThorChatMessage(string role, IList<MessageContent> contents, string? name = null,
