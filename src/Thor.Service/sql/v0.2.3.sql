...
INSERT INTO "ModelManagers" ("Id", "Model", "Enable", "Description", "Available", "CompletionRate", "PromptRate", "AudioPromptRate", "AudioOutputRate", "QuotaType", "QuotaMax", "Tags", "Icon", "IsVersion2", "UpdatedAt", "Modifier", "CreatedAt", "Creator") VALUES ('CD474EA3-CE84-473C-8C99-17ABB028012D', 'gpt-4o-realtime-preview', 1, 'gpt-4o-realtime 实时接口模型', 0, '10.0', '2.5', '50.0', '100.0', 1, '128K', '["\u6587\u672C","\u5B9E\u65F6"]', 'OpenAI', 1, null, null, '2024-10-31 00:33:43.8559299', 'fd8404e1-ffa7-431b-8827-b6b617330247');
