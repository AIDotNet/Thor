const enUS = {
  translation: {
    ...
    modelManager: {
      ...
      tieredPricingDescription: 'Token-based tiered pricing for different usage ranges',
      ...
      promptTiers: 'Prompt Tiers',
      completionTiers: 'Completion Tiers',
      cacheTiers: 'Cache Tiers',
      audioPromptTiers: 'Audio Prompt Tiers',
      audioOutputTiers: 'Audio Output Tiers',
      ...
      geminiTemplate: 'Gemini Template',
      applyGeminiTemplate: 'Apply Gemini Tiered Pricing Template',
      geminiTemplateDescription: 'Automatically configure Gemini-style tiered pricing (≤200K and >200K tiers)',
      // Context Pricing
      contextPricing: 'Context Pricing',
      enableContextPricing: 'Enable Context Pricing',
      contextPricingDescription: 'Dynamic pricing based on context length',
      contextTiers: 'Context Tiers',
      contextLength: 'Context Length',
      pricingMode: 'Pricing Mode',
      multiplierMode: 'Multiplier Mode',
      replacementMode: 'Replacement Mode',
      contextTemplate: 'Context Template',
      applyContextTemplate: 'Apply Context Pricing Template',
      contextTemplateDescription: 'Automatically configure context length-based pricing tiers',
      multiplierModeDescription: 'Apply multiplier to base rate',
      replacementModeDescription: 'Replace base rate entirely',
