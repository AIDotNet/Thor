const zhCN = {
  translation: {
    ...
    modelManager: {
      ...
      // 分层定价
      tieredPricing: '分层定价',
      enableTieredPricing: '启用分层定价',
      tieredPricingDescription: '基于token数量区间的分层定价',
      pricingTiers: '定价层级',
      tokenThreshold: 'Token阈值',
      rate: '费率',
      ...
      cacheTiers: '缓存分层',
      audioPromptTiers: '音频提示词分层',
      audioOutputTiers: '音频输出分层',
      unlimitedTokens: '无限制',
      tokensRange: 'Token范围',
      ...
      rateRequired: '费率不能为空',
      geminiTemplate: 'Gemini模板',
      applyGeminiTemplate: '应用Gemini分层定价模板',
      geminiTemplateDescription: '自动配置Gemini风格的分层定价（≤200K和>200K两个层级）',
      // 上下文定价
      contextPricing: '上下文定价',
      enableContextPricing: '启用上下文定价',
      contextPricingDescription: '基于上下文长度的动态定价',
      contextTiers: '上下文层级',
      contextLength: '上下文长度',
      pricingMode: '定价模式',
      multiplierMode: '倍率模式',
      replacementMode: '替换模式',
      contextTemplate: '上下文模板',
      applyContextTemplate: '应用上下文定价模板',
      contextTemplateDescription: '自动配置基于上下文长度的定价层级',
      multiplierModeDescription: '在基础费率上应用倍率',
      replacementModeDescription: '完全替换基础费率',
